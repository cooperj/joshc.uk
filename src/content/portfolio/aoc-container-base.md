...
> Agri-OpenCore is funded by InnovateUK (Project number: 10041179) as part of the DEFRA "Farming Innovation Programme - large R&D partnership projects"
...
One of the more useful pieces is the support for graphical workflows. The repository includes a "VNC" image (`lcas.lincoln.ac.uk/vnc`), that can be used to expose X11 applications in a browser, which is helpful for remote monitoring or development.
